...
namespace JavaLauncher
{
    class Program
    {
        ...
        {
            ProcessStartInfo startInfo = new ProcessStartInfo("jre\\bin\\java", "--module-path jre\\javafx\\lib --add-modules javafx.base,javafx.controls,javafx.graphics,javafx.web,javafx.swing --add-opens javafx.controls/com.sun.javafx.scene.control.skin=ALL-UNNAMED --add-exports javafx.base/com.sun.javafx.collections=ALL-UNNAMED -jar .\\ImageTrans.jar");
